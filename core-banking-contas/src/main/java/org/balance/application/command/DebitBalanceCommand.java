...
public class DebitBalanceCommand {

    private final String accountId; // conta que sofrerá o débito

    private final BigDecimal amount; // valor a ser debitado
