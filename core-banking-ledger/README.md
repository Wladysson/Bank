...
## Running the application in dev mode play in application
...
You can then execute your native executable with: `./target/core-banking-ledger-1.0.0-SNAPSHOT-runner`
